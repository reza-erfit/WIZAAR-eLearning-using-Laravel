<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-4 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        <div class="avatar-lg me-4">
          <img src="/html&css/assets/img/team/profile-picture-3.jpg" class="card-img-top rounded-circle border-white"
            alt="Bonnie Green">
        </div>
        <div class="d-block">
          <h2 class="h5 mb-3">Hi, Jane</h2>
          <a href="/html&css/pages/examples/sign-in.html" class="btn btn-secondary btn-sm d-inline-flex align-items-center">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="/dashboard" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">   
            <img src="/html&css/assets/img/brand/light.svg" height="20" width="20" alt="Volt Logo">
          </span>
          <span class="mt-1 ms-1 sidebar-text">WIZAAR | Dashboard</span>
        </a>
      </li>
      ...
      <li class="nav-item {{ Request::is('dashboard/pelajarans*') ? 'active':''}}">
        <a href="/dashboard/pelajarans" class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
            ...
            <span class="sidebar-text">Pelajaran</span>
          </span>

        </a>
      </li>
      <li class="nav-item {{ Request::is('dashboard/materis*') ? 'active':''}}">
        <a href="/dashboard/materis" class="nav-link">
          <span class="sidebar-icon">
